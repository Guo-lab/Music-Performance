% These are the piano key numbers and the corresponding durations for Fur Elise.
%
% t and tdur are for the treble clef or upper part and b and bdur are for the bass clef or lower part.
% A duration of 1 corresponds to an EIGHTH note and a note value of 0 is a REST.
